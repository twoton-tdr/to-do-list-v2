...
const todoElements = (function () {
    function createToDo(projectName) {
        ...
        function cardDialog(e, projectName) {
            ...
            const listToDo = projectModule.getListFromProject(projectName);
            ...
            const confirmUpdateButton =
                document.querySelector('#confirmUpdate');
            ...
            const statusCompletedButton =
                document.querySelector('#statusCompleted');
            ...
            function handleStatusChange() {
                ...
                createCards();
                statusCompletedButton.removeEventListener(
                    'click',
                    handleStatusChange
                );
                eventEditor.close();
